...
<div class="container-fluid bg_img">
    <center><p class="login_text">Delete staff</p></center>
<form action="deletestaff2.inc.php" method="post">
    <div>
<label for="name">Name  :</label>
<input type="text" id="name" placeholder="Name" name="name" required>
</div>
       <div>
<label for="no">userid  :</label>
<input type="number" id="no" placeholder="userid" name="userid" required>
</div>
    
      <div>
<label for="no1">username  :</label>
<input type="text" id="no1" placeholder="username" name="username" required>
</div>
    <div>
