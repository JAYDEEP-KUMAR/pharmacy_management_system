...
<div class="container-fluid bg_img">
    <center><p class="login_text">Sales Return</p></center>
<form action="salesreturn2.inc.php" method="post">
  
        <div>
<label for="sid">sid :</label>
<input type="text" id="sid" placeholder="sid" name="sid" required>
</div>
    <div>
<label for="mobileno">mobileno :</label>
<input type="number" id="mobileno" placeholder="mobileno" name="mobileno" required>
</div>
<div>
<label for="itemname">itemname :</label>
<input type="text" id="itemname" placeholder="itemname" name="itemname" required>
</div>
