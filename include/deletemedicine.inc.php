...
<div class="container-fluid bg_img">
    <center><p class="login_text">Delete Medicine</p></center>
<form action="deletemedicine2.inc.php" method="post">
    <div>
<label for="name">Name  :</label>
<input type="text" id="name" placeholder="Name" name="itemname" required>
</div>
       <div>
<label for="no">Itemno  :</label>
<input type="number" id="no" placeholder="itemono" name="itemno" required>
</div>
    <div>
