...
----->
            ...
            <a href="../include/deletestaff.inc.php" target="if"><button class="bu">Delete Staff</button></a>
            ...
            <a href="../include/staffdata.inc.php" target="if"><button class="bu">StaffData</button></a>

    </div>
    <div class="container-fluid right">
        <div class="container_title"><p>Your Results <a href="../include/logout.php"><button class="logout">Logout</button></a></p></div>
        <iframe src="../include/welcome.inc.php" name="if" width="1200px" style="margin-left:-17px;" height="700px" ></iframe>
    </div>
</div>        
</body>    
</html>
...
<?php
  ...
  /// else for if who_are is different   .......      
       ...
       echo "sorry you are not admin tahnk you login agin again don't try this otherwise may be i'll take legal action thank you so much     dhanyabaad...";
